...
DEBUG = False
ALLOWED_HOSTS = ['2400030008.pythonanywhere.com', 'localhost', '127.0.0.1']
INSTALLED_APPS = [
    ...
    'users', 'students', 'attendance', 'grades', 'timetable',
]
MIDDLEWARE = [
...
TEMPLATES = [{'BACKEND': 'django.template.backends.django.DjangoTemplates','DIRS': [BASE_DIR / 'templates'],'APP_DIRS': True,'OPTIONS': {'context_processors': ['django.template.context_processors.debug','django.template.context_processors.request',
                'students.context_processors.sidebar_students','django.contrib.auth.context_processors.auth','django.contrib.messages.context_processors.messages','django.template.context_processors.static',]},}]
...
if os.environ.get('USE_SQLITE', '').lower() in {'1', 'true', 'yes'}:
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'charan@29'),
